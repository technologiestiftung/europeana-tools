...
function sendReceive(data, id) {
    ...
    xhr.send(JSON.stringify({ data: data, id: id }));
}
var multiplier = 0.5;
...
function compute(src, id) {
    ...
    var srcParts = src.split("europeana_downloads_complete/");
    ...
    imageElement.onload = function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    input = tf.browser.fromPixels(imageElement);
                    return [4 /*yield*/, net.estimatePoses(input, {
